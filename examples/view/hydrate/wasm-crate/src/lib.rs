...
impl App {
    ...
    fn __build(self: &Rc<Self>) {
        ...
        let __t2 = document.create_text_node("SSR → client hydration");
        ...
        let __el5 = document.create_element("span").unwrap();
        __el5.set_attribute("class", "nm").unwrap();
        let __interp6 = format!("{}", (*self.name.borrow()));
        let __t7 = document.create_text_node(&__interp6);
        __el5.append_child(&__t7).unwrap();
        *self.__ktext_0.borrow_mut() = Some(__t7.clone());
        __el3.append_child(&__el5).unwrap();
        ...
        let __t10 = document.create_text_node("Your name");
        ...
        *self.__kattr_1.borrow_mut() = Some(__el11.clone());
        ...
        let __t13 = document.create_text_node("reset");
    ...
    pub fn hydrate(self: &Rc<Self>, root: HtmlElement) -> Result<(), JsValue> {
        ...
        *self.root.borrow_mut() = Some(root);
        ...
        if let Some(__hn) = __flv_next_text(&mut __hcur7) { *self.__ktext_0.borrow_mut() = Some(__hn); }
        }
        }
