...
| 9. Cierre formal + release | ✅ | _(SHA en commit-chore follow-up)_ | v0.17.0 bump: CHANGELOG + roadmap + deudas + CLAUDE refresh + Cargo.toml + extensión VSCode 0.17.0 + `.vsix` regenerado + blog drafts ES/EN. Smoke 363 ejemplos verde + fmt + clippy (default + lsp) limpios. |
